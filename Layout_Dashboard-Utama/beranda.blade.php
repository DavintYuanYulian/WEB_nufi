...
<body>
                ...
                <div class="navbar-nav mx-auto gap-lg-5 gap-3"> <!-- Gunakan gap kecil di layar kecil -->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="#data-pengajar">Data Guru</a></li>
                        </ul>
                    </li>
                    ...
                    <a class="nav-link {{ request()->is('pengumuman') ? 'active' : '' }}"
                        href="{{ url('/pengumuman') }}"><b>PENGUMUMAN</b></a>
    ...
    <div class="carousel-container">
        <div id="carouselExample" class="carousel slide carousel-shadow" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                <!-- Slide Pertama -->
                <div class="carousel-item active bg-gradient d-block w-00">
                    <!-- Caption atas -->
                    ...
                    <!-- Caption bawah -->
                    <div class="carousel-caption bottom-caption d-none d-md-block">
                        <h5 class="address-text"> Jl. Gg. Cendana, RT.02/RW.04, Manggar, Manggarmas, Kec. Godong,
                            Kabupaten
                            Grobogan, Jawa
                            Tengah 58162</h5>
                    </div>
    ...
    <div class="tentang-kami bg-gradient animated-section">
        <h2 class="tentang-kami-title text-center text-white mb-5">
    ...
    <div class="pengajar-section animated-section">
        ...
        <div class="show-more-btn">
            <a href="#guru-section"><span>Show More</span>
            </a>
        </div>
    </div>
    ...
    <div class="hubungi-kami-section animated-section" id="layanan-online">
        ...
        <div class="hubungi-kami p-4 rounded">
            ...
            <div class="d-flex justify-content-center"> <a href="https://wa.me/1234567890" target="_blank"
    ...
    <div class="temukan-kami-section">
        ...
        <div class="row" style="display: flex; align-items: flex-start; text-align: left; margin-top: 20px;">
            <div class="col-md-4 text-center" style="padding: 15px;">
                ...
                <h4>Alamat</h4>
                <p style=" font-size: 20px">Jl. Gg. Cendana, RT.02/RW.04, <br> Manggar, Manggarmas, Kec. Godong,<br> Kabupaten Grobogan,
                    Jawa Tengah 58162</p>
            </div>
            <div class="col-md-4 text-center" style="padding: 15px;">
                <h4>Kontak</h4>
